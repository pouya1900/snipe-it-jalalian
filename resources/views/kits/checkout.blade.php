        ...
        <form class="form-horizontal" method="post" action="" autocomplete="off">
          ...
          <!-- Checkout/Checkin Date -->
              <div class="form-group {{ $errors->has('checkout_at') ? 'error' : '' }}">
                  ...
                  <div class="col-md-8">
                      <div class="input-group date col-md-5" >
                          <input type="text" class="form-control persiandatepicker" placeholder="{{ trans('general.select_date') }}" name="checkout_at" id="checkout_at" value="{{ Request::old('checkout_at') }}">
              ...
              <div class="form-group {{ $errors->has('expected_checkin') ? 'error' : '' }}">
                  ...
                  <div class="col-md-8">
                      <div class="input-group date col-md-5" data-date-format="yyyy-mm-dd" data-date-start-date="0d">
                          <input type="text" class="form-control persiandatepicker" placeholder="{{ trans('general.select_date') }}" name="expected_checkin" id="expected_checkin" value="{{ Request::old('expected_checkin') }}">
                          <span class="input-group-addon"><i class="fas fa-calendar"></i></span>
                      </div>
