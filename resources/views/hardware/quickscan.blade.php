            ...
            <div class="box box-default">
                    ...
                    <!-- Update location -->
                        ...
                        <div class="form-group {{ $errors->has('next_audit_date') ? 'error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group date col-md-5"  data-date-format="yyyy-mm-dd" data-date-clear-btn="true">
                                    <input type="text" class="form-control persiandatepicker" placeholder="{{ trans('general.next_audit_date') }}" name="next_audit_date" id="next_audit_date" value="{{ old('next_audit_date', $next_audit_date) }}">
