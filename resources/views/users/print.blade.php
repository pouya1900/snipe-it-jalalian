        ...
        <table class="inventory">
            ...
            @foreach ($licenses as $license)
                ...
                <tr>
                    ...
                    <td>{{  \App\Helpers\Helper::getFormattedDateObject($license->pivot->created_at, 'datetime')['formatted'] }}</td>
                </tr>
                @php
                    $lcounter++
                @endphp
            ...
            @foreach ($accessories as $accessory)
                @if ($accessory)
                    <tr>
                        ...
                        <td>{{ \App\Helpers\Helper::getFormattedDateObject($accessory->pivot->created_at, 'datetime')['formatted'] }}</td>
                    </tr>
                    @php
                        $acounter++
                    @endphp
                ...
                @if ($consumable)
                    <tr>
                        ...
                        @if ($consumable->deleted_at!='')
                            ...
                            <td>{{  \App\Helpers\Helper::getFormattedDateObject($consumable->pivot->created_at, 'datetime')['formatted'] }}</td>
                    </tr>
                    @php
                        $ccounter++
                    @endphp
