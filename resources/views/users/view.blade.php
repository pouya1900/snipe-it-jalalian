                  ...
                  <tbody>
                    @foreach ($user->uploads as $file)
                        <tr>
                            ...
                            <td>{{ \App\Helpers\Helper::getFormattedDateObject($file->created_at, 'datetime')['formatted'] }}</td>
            ...
            <table class="table display table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ \App\Helpers\Helper::getFormattedDateObject($location->created_at, 'datetime')['formatted'] }}</td>
                </tr>
                @endforeach
              </tbody>
          </table>
